...
export function TicketsClient({
  ...
  useEffect(() => {
    // busca tickets do workspace
    // substitua esse trecho no useEffect
    const q = query(
        ...
        <div className="fixed inset-0 bg-black/80 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
          <div className="bg-gray-900 border border-gray-800 rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-5 flex flex-col gap-4">
              ...
              {/* Atribuir para — admin vê todos, membro só vê a si mesmo */}
        ...
        <div className="fixed inset-0 bg-black/80 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4">
          <div className="bg-gray-900 border border-gray-800 rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-5 flex flex-col gap-4">
              ...
              {/* Botão fechar/reabrir — admin ou criador podem fazer isso */}
